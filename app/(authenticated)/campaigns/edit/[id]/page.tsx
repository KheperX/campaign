...
interface CampaignData {
  ...
  daily_limit: number;
  campaign_type: string; // Changed from string | null
  tier_requirement: string; // Changed from string | null
  ticket_count: number;
}
...
export default function EditCampaignPage() {
    ...
    const fetchCampaign = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          campaign_start_date: formatDate(campaignData.campaign_start_date),
          campaign_end_date: formatDate(campaignData.campaign_end_date),
          daily_limit: campaignData.daily_limit,
          campaign_type: campaignData.campaign_type ?? "",
          tier_requirement: campaignData.tier_requirement ?? "",
          ticket_count: campaignData.ticket_count,
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        setErrorMessage("Error updating campaign: " + error.message);
      } else {
